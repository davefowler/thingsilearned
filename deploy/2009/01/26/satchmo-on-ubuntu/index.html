...
<p>Some keywords for the common error with the locale: bad settings.LANGUAGE_CODE satchmo</p>         </article>
     </div>
</div>
          </section>
      </div>
