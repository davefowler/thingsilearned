...
<head>
  ...
  <title>GNU Screen Basic Tutorial</title>
    ...
    <ul class='breadcrumb'>
     ...
     <div class="span8">
         ...
         <div class='page-header'>
               <h1>GNU Screen Basic Tutorial</h1>
         </div>
...
<p><em><strong>Update 6-3-2009:</strong></em> A few fixes were made thanks to Ben Finney's comments</p>         </article>
     </div>
</div>
          </section>
      </div>
