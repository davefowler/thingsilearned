...
<li>
<p>Open the settings.py in your django app and configure your email with the given credentials.  It should look something like this.</p>
<p>EMAIL_USE_TLS = True
...
<li>
<p>Test it out!./manage.py shell</p>
<blockquote>
<blockquote>
<blockquote>
<p>from django.core.mail import send_mail
send_mail('MailGun works great!', 'It really really does.', 'tester@YOURHOST.com', ['YOUREMAIL@gmail.com'], fail_silently=False)</p>
</blockquote>
</blockquote>
</blockquote>
</li>
